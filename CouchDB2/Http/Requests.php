...
class Requests
{
    ...
    public static function autoloader($class)
    {
        ...
        $file = str_replace('Fabs\CouchDB2\Http\\', '', $class);
    ...
    {
        spl_autoload_register(array('Fabs\CouchDB2\Http\Requests', 'autoloader'));
    }
    ...
    public static function add_transport($transport)
    {
        if (empty(self::$transports)) {
            self::$transports = array(
                'Fabs\CouchDB2\Http\Requests_Transport_cURL',
                'Fabs\CouchDB2\Http\Requests_Transport_cURL',
            );
        }
    ...
    protected static function get_transport($capabilities = array())
    {
        ...
        if (empty(self::$transports)) {
            self::$transports = array(
                'Fabs\CouchDB2\Http\Requests_Transport_cURL',
                'Fabs\CouchDB2\Http\Requests_Transport_fsockopen',
            );
        }
